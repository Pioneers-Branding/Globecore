            ...
            <div class="lg:w-1/3 xl:w-1/3 flex-shrink-0">
                <div class="sticky top-32 bg-white rounded-[32px] p-4 sm:p-5 shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-gray-100 flex flex-col items-center">
                    <div class="w-full rounded-[24px] overflow-hidden mb-6 bg-gray-100">
                        <img src="/assets/wp-content/uploads/2026/01/brick-background-74-819x1024.png" alt="Affiniti Harris-Mordecai, LCSW" class="w-full aspect-[4/5] object-cover object-top">
                    </div>
                    <div class="text-center w-full px-2">
                        <span class="inline-block bg-[#F1F6EC] text-[#7A9E3F] font-bold text-[11px] tracking-widest uppercase px-4 py-1.5 rounded-full mb-4">LCSW</span>
                        <h2 class="text-2xl font-bold text-[#071e26] mb-6">Affiniti Harris-Mordecai, LCSW</h2>
            ...
            <div class="lg:w-2/3 xl:w-2/3 flex flex-col gap-8">
                ...
                <div class="bg-white rounded-[40px] p-8 md:p-12 lg:p-14 shadow-sm border border-gray-100 relative overflow-hidden group">
                    ...
                    <div class="prose prose-lg max-w-none text-gray-600">
                        <p class="leading-relaxed">My therapeutic style is holistic, warm, and client-centered. I create a space where you feel genuinely seen and heard — free to explore difficult emotions without judgment. I integrate Cognitive Behavioral Therapy, positive visualization, mindfulness, and holistic techniques, including clinical hypnotherapy and Reiki, to support whole-person healing. My goal is to meet you where you are and walk with you toward where you want to be.</p>
                    </div>
                </div>
                <!-- PERSONAL HIGHLIGHTS -->
                <div class="bg-[#071e26] rounded-[40px] p-8 md:p-12 lg:p-14 shadow-lg relative overflow-hidden text-white group">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="prose prose-lg prose-invert max-w-none text-gray-300">
                            <p class="leading-relaxed">Affiniti Harris-Mordecai is a Licensed Clinical Social Worker and Clinical Hypnotherapist who is also a Reiki Master. She brings a uniquely integrative lens to mental health, combining evidence-based psychotherapy with holistic healing practices. She works with adults, children, adolescents, couples, and families on a wide range of concerns including <a href="/specialties/trauma.php" class="text-[#1C8193] underline hover:text-[#071e26] transition-colors font-medium">trauma</a>, <a href="/specialties/depression-anxiety.php" class="text-[#1C8193] underline hover:text-[#071e26] transition-colors font-medium">anxiety</a>, domestic violence, <a href="/specialties/depression-anxiety.php" class="text-[#1C8193] underline hover:text-[#071e26] transition-colors font-medium">depression</a>, and LGBTQ+ issues.</p>
                        </div>
                    </div>
                </div>
                <!-- SPECIALTIES -->
                <div class="bg-white rounded-[32px] p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                    ...
                    <ul class="space-y-4 text-gray-600"><li class="flex items-start gap-3"><svg class="w-5 h-5 text-primary mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg><span class="text-gray-600 font-medium">Trauma &amp; <a href="/specialties/trauma.php" class="text-[#1C8193] underline hover:text-[#071e26] transition-colors font-medium">PTSD</a></span></li><li class="flex items-start gap-3"><svg class="w-5 h-5 text-primary mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg><span class="text-gray-600 font-medium">Anxiety &amp; Depression</span></li><li class="flex items-start gap-3"><svg class="w-5 h-5 text-primary mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg><span class="text-gray-600 font-medium">Domestic Violence &amp; Abuse</span></li><li class="flex items-start gap-3"><svg class="w-5 h-5 text-primary mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg><span class="text-gray-600 font-medium">LGBTQ+ Issues</span></li><li class="flex items-start gap-3"><svg class="w-5 h-5 text-primary mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg><span class="text-gray-600 font-medium">Parenting &amp; Child/Adolescent Therapy</span></li><li class="flex items-start gap-3"><svg class="w-5 h-5 text-primary mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg><span class="text-gray-600 font-medium">Couples &amp; Family Therapy</span></li><li class="flex items-start gap-3"><svg class="w-5 h-5 text-primary mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg><span class="text-gray-600 font-medium"><a href="/specialties/grief-loss.php" class="text-[#1C8193] underline hover:text-[#071e26] transition-colors font-medium">Grief</a> &amp; Anger Management</span></li></ul>
                </div>
                <!-- EDUCATION -->
                <div class="bg-white rounded-[40px] p-8 md:p-12 shadow-sm border border-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4"><div class="bg-secondary/5 rounded-2xl p-6 border border-secondary/10 hover:bg-secondary/10 transition-colors"><p class="font-bold text-[#071e26] mb-1">Master of Social Work (MSW)</p><p class="text-gray-500 text-sm">Clark Atlanta University</p></div><div class="bg-secondary/5 rounded-2xl p-6 border border-secondary/10 hover:bg-secondary/10 transition-colors"><p class="font-bold text-[#071e26] mb-1">Clinical Hypnotherapy Certification</p><p class="text-gray-500 text-sm">National Guild of Hypnotists</p></div><div class="bg-secondary/5 rounded-2xl p-6 border border-secondary/10 hover:bg-secondary/10 transition-colors"><p class="font-bold text-[#071e26] mb-1">Reiki Master Certification</p></div></div>
                </div>
                <!-- LICENSES -->
                <div class="bg-white rounded-[40px] p-8 md:p-12 shadow-sm border border-gray-100">
                    <div class="flex items-center gap-4 mb-8">
                    ...
                    <ul class="space-y-4 text-gray-600"><li class="flex items-start gap-3"><div class="w-1.5 h-1.5 rounded-full bg-secondary mt-2 flex-shrink-0 ring-4 ring-secondary/20"></div><span class="font-medium text-[#071e26]">Licensed Clinical Social Worker (LCSW) – Georgia</span></li><li class="flex items-start gap-3"><div class="w-1.5 h-1.5 rounded-full bg-secondary mt-2 flex-shrink-0 ring-4 ring-secondary/20"></div><span class="font-medium text-[#071e26]">Certified Clinical Hypnotherapist</span></li><li class="flex items-start gap-3"><div class="w-1.5 h-1.5 rounded-full bg-secondary mt-2 flex-shrink-0 ring-4 ring-secondary/20"></div><span class="font-medium text-[#071e26]">Reiki Master</span></li></ul>
                </div>
            </div>
        </div>
</section>
