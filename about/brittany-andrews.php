            ...
            <div
                ...
                <div class="w-full md:w-5/12 flex-shrink-0">
                    <div class="rounded-[32px] overflow-hidden shadow-2xl relative group">
                        ...
                        <img src="/assets/images/brittany.webp"
                ...
                <div class="w-full md:w-7/12 flex flex-col justify-center">
                    <div class="flex items-center gap-3 mb-6">
                        <span
                            class="text-secondary font-bold tracking-widest text-[13px] uppercase bg-secondary/10 px-5 py-2 rounded-full inline-block">Manager
                            of Scheduling & Billing</span>
                    </div>
                    <h1
                    ...
                    <div class="prose prose-lg max-w-none text-gray-600 space-y-4">
                        <p class="text-gray-600 leading-relaxed mb-6">I am the manager of the entire
                            scheduling/billing/collections team. I have over 10 years of Management experience and help
                            with any questions or concerns you may have with scheduling, billing, statements, or time of
                            service payments.</p>

                        <h3 class="text-2xl font-bold text-[#071e26] mt-8 mb-4">My Hobbies</h3>
                        <p class="text-gray-600 leading-relaxed mb-6">Outside of working, I enjoy hanging out with
