            ...
            <div class="lg:w-1/3 xl:w-1/3 flex-shrink-0">
                <div class="sticky top-32 bg-white rounded-[32px] p-4 sm:p-5 shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-gray-100 flex flex-col items-center">
                    <div class="w-full rounded-[24px] overflow-hidden mb-6 bg-gray-100">
                        <img src="assets/wp-content/uploads/2021/03/IMG_2997-818x1024.jpg" alt="SueEllen Hollowell, LPC, NCC" class="w-full aspect-[4/5] object-cover object-top">
                    </div>
                    <div class="text-center w-full px-2">
                        ...
                        <h2 class="text-2xl font-bold text-[#071e26] mb-6">SueEllen Hollowell, LPC, NCC</h2>
            ...
            <div class="lg:w-2/3 xl:w-2/3 flex flex-col gap-8">
                ...
                <div class="bg-white rounded-[40px] p-8 md:p-12 lg:p-14 shadow-sm border border-gray-100 relative overflow-hidden group">
                    ...
                    <div class="prose prose-lg max-w-none text-gray-600">
                        <p class="leading-relaxed">I provide a safe, supportive, and compassionate environment where you can explore difficult emotions and experiences. My approach is collaborative and holistic — I work alongside you to identify your strengths, clarify your goals, and develop strategies that are meaningful and effective for your particular circumstances. I draw on multiple therapeutic frameworks and tailor each session to honor your unique journey.</p>
                    </div>
                </div>
                <!-- PERSONAL HIGHLIGHTS -->
                <div class="bg-[#071e26] rounded-[40px] p-8 md:p-12 lg:p-14 shadow-lg relative overflow-hidden text-white group">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="prose prose-lg prose-invert max-w-none text-gray-300">
                            <p class="leading-relaxed">SueEllen Hollowell is a Licensed Professional Counselor and National Certified Counselor who specializes in helping individuals, couples, and families navigate life's most challenging moments. With warm, empathetic care, she helps clients build resilience, heal from <a href="/specialties/trauma.php" class="text-[#1C8193] underline hover:text-[#071e26] transition-colors font-medium">trauma</a>, and cultivate deeper self-understanding. Her background includes working with diverse populations across a range of issues including <a href="/specialties/grief-loss.php" class="text-[#1C8193] underline hover:text-[#071e26] transition-colors font-medium">grief</a>, relationship struggles, and <a href="/specialties/depression-anxiety.php" class="text-[#1C8193] underline hover:text-[#071e26] transition-colors font-medium">anxiety</a>.</p>
                        </div>
                    </div>
                </div>
                <!-- SPECIALTIES -->
                <div class="bg-white rounded-[32px] p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                    ...
                    <ul class="space-y-4 text-gray-600"><li class="flex items-start gap-3"><svg class="w-5 h-5 text-primary mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg><span class="text-gray-600 font-medium">Grief &amp; Loss</span></li><li class="flex items-start gap-3"><svg class="w-5 h-5 text-primary mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg><span class="text-gray-600 font-medium">Life Transitions</span></li><li class="flex items-start gap-3"><svg class="w-5 h-5 text-primary mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg><span class="text-gray-600 font-medium"><a href="/specialties/depression-anxiety.php" class="text-[#1C8193] underline hover:text-[#071e26] transition-colors font-medium">Depression</a> &amp; Anxiety</span></li><li class="flex items-start gap-3"><svg class="w-5 h-5 text-primary mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg><span class="text-gray-600 font-medium">Trauma &amp; <a href="/specialties/trauma.php" class="text-[#1C8193] underline hover:text-[#071e26] transition-colors font-medium">PTSD</a></span></li><li class="flex items-start gap-3"><svg class="w-5 h-5 text-primary mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg><span class="text-gray-600 font-medium">Relationship &amp; Couples <a href="/services/counseling.php" class="text-[#1C8193] underline hover:text-[#071e26] transition-colors font-medium">Counseling</a></span></li><li class="flex items-start gap-3"><svg class="w-5 h-5 text-primary mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg><span class="text-gray-600 font-medium">Family Therapy</span></li><li class="flex items-start gap-3"><svg class="w-5 h-5 text-primary mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg><span class="text-gray-600 font-medium"><a href="/specialties/self-esteem.php" class="text-[#1C8193] underline hover:text-[#071e26] transition-colors font-medium">Self-Esteem</a> &amp; Empowerment</span></li></ul>
                </div>
                <!-- EDUCATION -->
                <div class="bg-white rounded-[40px] p-8 md:p-12 shadow-sm border border-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4"><div class="bg-secondary/5 rounded-2xl p-6 border border-secondary/10 hover:bg-secondary/10 transition-colors"><p class="font-bold text-[#071e26] mb-1">Master of Education – Agency Counseling</p><p class="text-gray-500 text-sm">University of Georgia</p></div><div class="bg-secondary/5 rounded-2xl p-6 border border-secondary/10 hover:bg-secondary/10 transition-colors"><p class="font-bold text-[#071e26] mb-1">Bachelor of Science – Psychology</p><p class="text-gray-500 text-sm">Kennesaw State University</p></div></div>
                </div>
                <!-- LICENSES -->
                <div class="bg-white rounded-[40px] p-8 md:p-12 shadow-sm border border-gray-100">
                    <div class="flex items-center gap-4 mb-8">
