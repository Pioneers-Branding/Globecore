            ...
            <div
                ...
                <div class="w-full md:w-5/12 flex-shrink-0">
                    <div class="rounded-[32px] overflow-hidden shadow-2xl relative group">
                        ...
                        <img src="/wp-content/uploads/2022/11/brick-background-22.png"
                            alt="Marcos Lopez"
                ...
                <div class="w-full md:w-7/12 flex flex-col justify-center">
                    <div class="flex items-center gap-3 mb-6">
                        <span
                            class="text-secondary font-bold tracking-widest text-[13px] uppercase bg-secondary/10 px-5 py-2 rounded-full inline-block">Lead
                            Scheduler</span>
                    </div>
                    <h1
                    ...
                    <div class="prose prose-lg max-w-none text-gray-600 space-y-4">
                        <p class="text-gray-600 leading-relaxed mb-6">Hello! I’m Marcos and I specialize in customer
                            service with 10+ years in experience in fast-pace environments with high volume. With a
                            management background in Quality Assurance, I make this my number one priority in all
                            aspects of my work. Mainly, I handle day-to-day operations which include initial client
                            intake, scheduling, referrals, and managing records request. I also handle various admin
                            tasks to help keep our office running smoothly and efficiently. Our success lies in our
                            partnership with our Clinicians and Verifications team. Together, we keep a healthy
                            partnership in order to provide a better service.</p>

                        <h3 class="text-2xl font-bold text-[#071e26] mt-8 mb-4">My Hobbies</h3>
                        <p class="text-gray-600 leading-relaxed mb-6">Family Time<br>Scorsese, Tarantino, Ritchie
                            films<br>Disney/Pixar/Ghibli films with my kids<br>A Song of Ice and Fire
                            universe<br>Technology<br>Occasional outings</p>
                    </div>
