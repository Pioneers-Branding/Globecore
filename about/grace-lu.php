            ...
            <div
                ...
                <div class="w-full md:w-5/12 flex-shrink-0">
                    <div class="rounded-[32px] overflow-hidden shadow-2xl relative group">
                        ...
                        <img src="/wp-content/uploads/2024/03/brick-background-68-819x1024.png"
                            alt="Grace Lu"
                ...
                <div class="w-full md:w-7/12 flex flex-col justify-center">
                    <div class="flex items-center gap-3 mb-6">
                        <span
                            class="text-secondary font-bold tracking-widest text-[13px] uppercase bg-secondary/10 px-5 py-2 rounded-full inline-block">Client
                            Support Specialist</span>
                    </div>
                    <h1
                    ...
                    <div class="prose prose-lg max-w-none text-gray-600 space-y-4">
                        <p class="text-gray-600 leading-relaxed mb-6">I’m Grace, with over 8 years of extensive
                            experience and a robust background in the healthcare industry, I specialize in customer
                            service and client services management. I have a diverse background in Quality Assurance,
                            Customer Service, Transition Management, and Client Services Management. I am confident in
                            my ability to bring a unique blend of skills and experience. With my expertise, I will
                            ensure streamlined and efficient appointment booking processes, providing patients with the
                            care they need when they need it most. Let me take the hassle out of scheduling, so clients
                            can focus on what matters most – their health.</p>

                        <h3 class="text-2xl font-bold text-[#071e26] mt-8 mb-4">My Hobbies</h3>
                        <p class="text-gray-600 leading-relaxed mb-6">I'm someone who finds joy in exploring the world
                            through travel, indulging my taste buds with culinary adventures in the kitchen, and getting
                            lost in the pages of a good book. Yet, amidst these passions, my heart truly belongs to
                            spending quality time with my family creating cherished memories together that will last a
                            lifetime.</p>
                    </div>
