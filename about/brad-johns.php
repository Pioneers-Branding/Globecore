...
<!-- Main Content -->
<main class="py-12 lg:py-20 bg-[#fafafa] relative" id="content">
...
<!-- Back Button -->
<div class="mb-10">
<a class="inline-flex items-center gap-2 text-secondary hover:text-primary font-bold transition-all bg-white px-5 py-2.5 rounded-full shadow-sm hover:shadow-md border border-gray-100 group" href="meet-our-team.php">
<svg class="w-5 h-5 group-hover:-translate-x-1 transition-transform" fill="none" stroke="currentColor" viewbox="0 0 24 24"><path d="M10 19l-7-7m0 0l7-7m-7 7h18" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path></svg>
...
<img alt="Brad Johns, LMSW" class="w-full aspect-[4/5] object-cover object-top" src="/assets/images/brick-background-59-768x960.png"/>
</div>
...
<h3 class="font-bold text-[#027289] text-base mb-2">Chief Resident</h3>
<p class="text-[#071e26] font-semibold mb-1 leading-snug text-sm">Dept. of Psychiatry &amp; Behavioral Sciences</p>
<p class="text-sm text-gray-500">Emory School of Medicine, Emory University, Atlanta, GA</p>
</div>
<div class="bg-[#f4f8f9] rounded-2xl p-6 border border-[#027289]/10 hover:shadow-md transition-shadow">
<h3 class="font-bold text-[#027289] text-base mb-2">Residency</h3>
<p class="text-[#071e26] font-semibold mb-1 leading-snug text-sm">Emory School of Medicine</p>
<p class="text-sm text-gray-500">Emory University, Atlanta, GA</p>
</div>
<div class="bg-[#f4f8f9] rounded-2xl p-6 border border-[#027289]/10 hover:shadow-md transition-shadow">
<h3 class="font-bold text-[#027289] text-base mb-2">Medical School</h3>
<p class="text-[#071e26] font-semibold mb-1 leading-snug text-sm">M.D. Case Western Reserve School of Medicine, Cleveland, OH</p>
<p class="text-sm text-gray-500">Post-Baccalaurete</p>
</div>
<div class="bg-[#f4f8f9] rounded-2xl p-6 border border-[#027289]/10 hover:shadow-md transition-shadow">
<h3 class="font-bold text-[#027289] text-base mb-2">Pre-Med program</h3>
<p class="text-[#071e26] font-semibold mb-1 leading-snug text-sm">Bryn Mawr College, Bryn Mawr, PA</p>
<p class="text-sm text-gray-500">Graduate</p>
</div>
<div class="bg-[#f4f8f9] rounded-2xl p-6 border border-[#027289]/10 hover:shadow-md transition-shadow">
<h3 class="font-bold text-[#027289] text-base mb-2">Harvard University, Cambridge, MA</h3>
<p class="text-[#071e26] font-semibold mb-1 leading-snug text-sm">Undergraduate</p>
<p class="text-sm text-gray-500">Tulane University, New Orleans, LA</p>
</div>
<div class="bg-[#f4f8f9] rounded-2xl p-6 border border-[#027289]/10 hover:shadow-md transition-shadow">
<h3 class="font-bold text-[#027289] text-base mb-2">Magna cum Laude with departmental honors</h3>
</div>
</div>
</div>
<!-- Titles & Affiliations -->
<div class="bg-white rounded-[32px] p-8 md:p-10 shadow-sm border border-gray-100">
<h2 class="text-3xl font-extrabold text-[#071e26] mb-6">Titles &amp; Affiliations</h2>
<ul class="space-y-4">
...
<span class="font-medium text-[#071e26]">Clinical Assistant Professor of Psychiatry: Medical College of Georgia, 2017-present</span>
</li>
<li class="flex items-start gap-4 bg-[#f4f8f9] p-4 rounded-2xl">
<span class="w-2.5 h-2.5 rounded-full bg-[#027289] flex-shrink-0 mt-1.5 ring-4 ring-[#027289]/10"></span>
<span class="font-medium text-[#071e26]">Adjunct Clinical Assistant Professor of Psychiatry: Emory University, 2017-present</span>
</li>
<li class="flex items-start gap-4 bg-[#f4f8f9] p-4 rounded-2xl">
<span class="w-2.5 h-2.5 rounded-full bg-[#027289] flex-shrink-0 mt-1.5 ring-4 ring-[#027289]/10"></span>
<span class="font-medium text-[#071e26]">Skyland Trail: Chairman, Professional Advisory Board, 2005-2007</span>
</li>
<li class="flex items-start gap-4 bg-[#f4f8f9] p-4 rounded-2xl">
<span class="w-2.5 h-2.5 rounded-full bg-[#027289] flex-shrink-0 mt-1.5 ring-4 ring-[#027289]/10"></span>
<span class="font-medium text-[#071e26]">Group Medical Director: Acadia Behavioral Health Care, 2016-2020</span>
</li>
<li class="flex items-start gap-4 bg-[#f4f8f9] p-4 rounded-2xl">
<span class="w-2.5 h-2.5 rounded-full bg-[#027289] flex-shrink-0 mt-1.5 ring-4 ring-[#027289]/10"></span>
<span class="font-medium text-[#071e26]">Medical Director: Ridgeview Insititute, 2009-2015</span>
</li>
</ul>
</div>
<!-- Personal Highlights -->
...
<p class="leading-relaxed">Dr. Johns is a highly experienced psychiatrist who offers a broad range of psychiatric services, including general adult psychiatry and adolescent psychiatry. He has particular expertise in both psychotherapy and psychopharmacology. At GlobeCore, Dr. Johns serves as a collaborating psychiatrist, providing essential support to our nurse practitioner/prescriber. While he is currently not available to take on new clients directly at GlobeCoRe, he plays a crucial role in overseeing the treatment of the clients under the care of the nurse practitioner.</p>
</div>
</div>
</div>
</div>
<!-- END OF TWO COLUMN LAYOUT --></section></main>
