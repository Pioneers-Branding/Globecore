            ...
            <div class="lg:w-1/3 xl:w-1/3 flex-shrink-0">
                <div class="sticky top-32 bg-white rounded-[32px] p-4 sm:p-5 shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-gray-100 flex flex-col items-center">
                    <div class="w-full rounded-[24px] overflow-hidden mb-6 bg-gray-100">
                        <img src="assets/wp-content/uploads/2023/10/screen-shot-2023-10-24-at-7.52.25-am-1024x1024.png" alt="Brad Johns, LMSW" class="w-full aspect-[4/5] object-cover object-top">
                    </div>
                    <div class="text-center w-full px-2">
                        <span class="inline-block bg-[#F1F6EC] text-[#7A9E3F] font-bold text-[11px] tracking-widest uppercase px-4 py-1.5 rounded-full mb-4">LMSW</span>
                        <h2 class="text-2xl font-bold text-[#071e26] mb-6">Brad Johns, LMSW</h2>
            ...
            <div class="lg:w-2/3 xl:w-3/4 flex flex-col gap-8">
                ...
                <div class="bg-white rounded-[40px] p-8 md:p-12 lg:p-14 shadow-sm border border-gray-100 relative overflow-hidden group">
                    ...
                    <div class="prose prose-lg max-w-none text-gray-600">
                        <p class="leading-relaxed">I strive to create a safe, non-judgmental space where you can explore who you are, where you're going, and what you need to thrive. My style is direct, collaborative, and strengths-based. I won't just sit back and nod — I engage actively, offer insight, and provide the structure needed to move toward meaningful change. I tailor my approach to fit each individual, recognizing that no single method works for everyone.</p>
                    </div>
                </div>
                <!-- PERSONAL HIGHLIGHTS -->
                <div class="bg-[#071e26] rounded-[40px] p-8 md:p-12 lg:p-14 shadow-lg relative overflow-hidden text-white group">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="prose prose-lg prose-invert max-w-none text-gray-300">
                            <p class="leading-relaxed">Brad Johns is a dedicated clinician who brings experience in mental health, crisis work, and motivational support. With a compassionate, straightforward style, he helps individuals navigate complex challenges including life transitions, <a href="../specialties/addiction.php" class="text-[#1C8193] underline hover:text-[#071e26] transition-colors font-medium">addiction</a>, <a href="../specialties/depression-anxiety.php" class="text-[#1C8193] underline hover:text-[#071e26] transition-colors font-medium">depression</a>, and <a href="../specialties/depression-anxiety.php" class="text-[#1C8193] underline hover:text-[#071e26] transition-colors font-medium">anxiety</a>. He is passionate about supporting adult men in redefining their narratives and building resilience.</p>
                        </div>
                    </div>
                </div>
                <!-- SPECIALTIES -->
                <div class="bg-white rounded-[32px] p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                    ...
                    <ul class="space-y-4 text-gray-600"><li class="flex items-start gap-3"><svg class="w-5 h-5 text-primary mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg><span>Depression &amp; Anxiety</span></li><li class="flex items-start gap-3"><svg class="w-5 h-5 text-primary mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg><span>Life Transitions</span></li><li class="flex items-start gap-3"><svg class="w-5 h-5 text-primary mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg><span>Addiction &amp; Recovery</span></li><li class="flex items-start gap-3"><svg class="w-5 h-5 text-primary mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg><span>Men's Issues &amp; Identity</span></li><li class="flex items-start gap-3"><svg class="w-5 h-5 text-primary mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg><span><a href="../specialties/trauma.php" class="text-[#1C8193] underline hover:text-[#071e26] transition-colors font-medium">Trauma</a> &amp; <a href="../specialties/trauma.php" class="text-[#1C8193] underline hover:text-[#071e26] transition-colors font-medium">PTSD</a></span></li><li class="flex items-start gap-3"><svg class="w-5 h-5 text-primary mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg><span><a href="../specialties/self-esteem.php" class="text-[#1C8193] underline hover:text-[#071e26] transition-colors font-medium">Self-Esteem</a> &amp; Confidence</span></li></ul>
                </div>
                <!-- EDUCATION -->
                <div class="bg-white rounded-[40px] p-8 md:p-12 shadow-sm border border-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4"><div class="bg-secondary/5 rounded-2xl p-6 border border-secondary/10 hover:bg-secondary/10 transition-colors"><p class="font-bold text-[#071e26] mb-1">Master of Social Work (MSW)</p><p class="text-gray-500 text-sm">Clark Atlanta University</p></div><div class="bg-secondary/5 rounded-2xl p-6 border border-secondary/10 hover:bg-secondary/10 transition-colors"><p class="font-bold text-[#071e26] mb-1">Bachelor of Science – Sociology</p><p class="text-gray-500 text-sm">Georgia Southern University</p></div></div>
                </div>
                <!-- LICENSES -->
                <div class="bg-white rounded-[40px] p-8 md:p-12 shadow-sm border border-gray-100">
                    <div class="flex items-center gap-4 mb-8">
                    ...
                    <ul class="space-y-4 text-gray-600"><li class="flex items-start gap-3"><div class="w-1.5 h-1.5 rounded-full bg-secondary mt-2 flex-shrink-0 ring-4 ring-secondary/20"></div><span class="font-medium text-[#071e26]">Licensed Master of Social Work (LMSW) – Georgia</span></li><li class="flex items-start gap-3"><div class="w-1.5 h-1.5 rounded-full bg-secondary mt-2 flex-shrink-0 ring-4 ring-secondary/20"></div><span class="font-medium text-[#071e26]">Registered Substance Abuse Professional (SAP)</span></li></ul>
                </div>
            </div>
        </div>
