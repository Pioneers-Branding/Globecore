            ...
            <div
                ...
                <div class="w-full md:w-5/12 flex-shrink-0">
                    <div class="rounded-[32px] overflow-hidden shadow-2xl relative group">
                        ...
                        <img src="/wp-content/uploads/2023/06/brick-background-31-819x1024.png"
                            alt="Stephen Luna"
                ...
                <div class="w-full md:w-7/12 flex flex-col justify-center">
                    <div class="flex items-center gap-3 mb-6">
                        <span
                            class="text-secondary font-bold tracking-widest text-[13px] uppercase bg-secondary/10 px-5 py-2 rounded-full inline-block">Administrative
                            Assistant</span>
                    </div>
                    <h1
                    ...
                    <div class="prose prose-lg max-w-none text-gray-600 space-y-4">
                        <p class="text-gray-600 leading-relaxed mb-6">I am the Administrative Assistant at GlobeCoRe and
                            I primarily handle administrative tasks, project work and provide support to existing
                            clients from appointment setting to billing concerns. I am passionate about helping others
                            and I am detail oriented in my tasks. I enjoy leveraging my skills to assist clients and
                            give them the best customer service experience they can receive. My background in the
                            Customer Service Industry for 7 years supports me in this work. I also worked in a hospital
                            for 5 years as an ER nurse.</p>

                        <h3 class="text-2xl font-bold text-[#071e26] mt-8 mb-4">My Hobbies</h3>
                        <p class="text-gray-600 leading-relaxed mb-6">I enjoy being a home buddy and love playing mobile
                            games and watching movies in my free time. Most of all, I love to spend time with my mother.
                            We enjoy exploring new restaurant so we can spend quality time together.</p>
                    </div>
