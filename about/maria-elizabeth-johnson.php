            ...
            <!-- RIGHT COLUMN: Bio Content -->
                <div class="lg:w-2/3 xl:w-3/4">
                    <div class="bg-white rounded-[40px] p-8 md:p-12 lg:p-14 shadow-sm border border-gray-100">
                        <p
                            class="text-secondary font-medium text-lg mb-8 uppercase tracking-widest pl-1 border-l-4 border-secondary">
                            Clinician</p>
                        <h1
                            class="text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#071e26] leading-tight mb-12 tracking-tight drop-shadow-sm">
                            Maria Elizabeth Johnson</h1>
                        ...
                        <div class="prose prose-lg max-w-none">
                            ...
                            <h3 class="text-2xl font-bold text-deepTeal mt-8 mb-4">Credentials</h3>
                            <p>Licensed clinician with advanced training in integrated behavioral health and psychiatry.</p>
                            <h3 class="text-2xl font-bold text-deepTeal mt-8 mb-4">Education</h3>
                            <p>Masters level clinical training, board certification, and continuing education in trauma and neurodiversity.</p>
                        </div>
                    </div>
                </div>
            </div>
