            ...
            <div
                ...
                <div class="w-full md:w-5/12 flex-shrink-0">
                    <div class="rounded-[32px] overflow-hidden shadow-2xl relative group">
                        ...
                        <img src="/wp-content/uploads/2025/07/26-819x1024.jpg"
                            alt="Eden Levites"
                ...
                <div class="w-full md:w-7/12 flex flex-col justify-center">
                    <div class="flex items-center gap-3 mb-6">
                        <span
                            class="text-secondary font-bold tracking-widest text-[13px] uppercase bg-secondary/10 px-5 py-2 rounded-full inline-block">TMS
                            Coordinator and Treater</span>
                    </div>
                    <h1
                    ...
                    <div class="prose prose-lg max-w-none text-gray-600 space-y-4">
                        ...
                        <p class="text-gray-600 leading-relaxed mb-6">My hobbies are working out, traveling, baking,
                            journaling and thrifting.</p>
                    </div>
