            ...
            <div class="lg:w-1/3 xl:w-1/3 flex-shrink-0">
                <div class="sticky top-32 bg-white rounded-[32px] p-4 sm:p-5 shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-gray-100 flex flex-col items-center">
                    <div class="w-full rounded-[24px] overflow-hidden mb-6 bg-gray-100">
                        <img src="assets/wp-content/uploads/2021/03/IMG_2989.jpg" alt="Victoria Taylor, LPC, NCC" class="w-full aspect-[4/5] object-cover object-top">
                    </div>
                    <div class="text-center w-full px-2">
                        ...
                        <h2 class="text-2xl font-bold text-[#071e26] mb-6">Victoria Taylor, LPC, NCC</h2>
            ...
            <div class="lg:w-2/3 xl:w-2/3 flex flex-col gap-8">
                ...
                <div class="bg-white rounded-[40px] p-8 md:p-12 lg:p-14 shadow-sm border border-gray-100 relative overflow-hidden group">
                    ...
                    <div class="prose prose-lg max-w-none text-gray-600">
                        <p class="leading-relaxed">My approach to <a href="../services/counseling.php" class="text-[#1C8193] underline hover:text-[#071e26] transition-colors font-medium">counseling</a> is centered on creating a warm, open, and judgment-free environment where you feel truly heard and understood. I believe you hold the wisdom within yourself, and my role is to help you access it. I use an integrated approach drawing from CBT, Motivational Interviewing, and mindfulness-based techniques, tailored to meet your unique needs and goals.</p>
                    </div>
                </div>
                <!-- PERSONAL HIGHLIGHTS -->
                <div class="bg-[#071e26] rounded-[40px] p-8 md:p-12 lg:p-14 shadow-lg relative overflow-hidden text-white group">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="prose prose-lg prose-invert max-w-none text-gray-300">
                            <p class="leading-relaxed">Victoria Taylor is a Licensed Professional Counselor and National Certified Counselor who is passionate about helping individuals navigate <a href="../specialties/depression-anxiety.php" class="text-[#1C8193] underline hover:text-[#071e26] transition-colors font-medium">anxiety</a>, <a href="../specialties/depression-anxiety.php" class="text-[#1C8193] underline hover:text-[#071e26] transition-colors font-medium">depression</a>, <a href="../specialties/trauma.php" class="text-[#1C8193] underline hover:text-[#071e26] transition-colors font-medium">trauma</a>, and life transitions. With a strengths-based approach, she empowers clients to discover their resilience and build the life they envision. Her practice integrates culturally-sensitive care with a focus on personal growth.</p>
                        </div>
                    </div>
                </div>
                <!-- SPECIALTIES -->
                ...
                <div class="bg-white rounded-[40px] p-8 md:p-12 shadow-sm border border-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4"><div class="bg-secondary/5 rounded-2xl p-6 border border-secondary/10 hover:bg-secondary/10 transition-colors"><p class="font-bold text-[#071e26] mb-1">Master of Arts – Clinical Mental Health Counseling</p><p class="text-gray-500 text-sm">Mercer University</p></div><div class="bg-secondary/5 rounded-2xl p-6 border border-secondary/10 hover:bg-secondary/10 transition-colors"><p class="font-bold text-[#071e26] mb-1">Bachelor of Science – Psychology</p><p class="text-gray-500 text-sm">University of Georgia</p></div></div>
                </div>
                <!-- LICENSES -->
                <div class="bg-white rounded-[40px] p-8 md:p-12 shadow-sm border border-gray-100">
                    <div class="flex items-center gap-4 mb-8">
