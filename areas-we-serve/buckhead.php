...
<head>
<?php
$pageTitle = "Therapist in Buckhead, GA | GlobeCoRe Inc. Atlanta, GA";
...
<body class="font-raleway text-textMain bg-white">
    ...
    <section class="relative pt-32 pb-40 lg:pt-40 lg:pb-48 overflow-hidden bg-[#071e26]">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 relative z-10 text-center">
            <div class="inline-flex items-center gap-2 bg-primary/20 border border-primary/30 rounded-full px-5 py-2 mb-8 backdrop-blur-md">
                ...
                <span class="text-white text-xs font-bold uppercase tracking-widest">Premium Buckhead Care</span>
            </div>
    ...
    <!-- CONTENT -->
    <main class="py-20 lg:py-28 bg-white relative">
        <div class="max-w-5xl mx-auto px-4 sm:px-6">
            <div class="flex flex-col lg:flex-row gap-16 items-center">
                <div class="lg:w-1/2 space-y-6">
                    <h2 class="text-3xl lg:text-5xl font-extrabold text-[#071e26] leading-tight">Elite Psychological Services for Buckhead Residents</h2>
    ...
    <section class="bg-[#071e26] py-14">
      <div class="max-w-6xl mx-auto px-4 sm:px-6 grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-white">
        <div><p class="text-4xl font-extrabold text-primary">0 min</p><p class="text-xs uppercase tracking-widest mt-1 text-gray-400">Located in Buckhead</p></div>
        <div><p class="text-4xl font-extrabold text-primary">Suite 1000</p><p class="text-xs uppercase tracking-widest mt-1 text-gray-400">On Lenox Road</p></div>
        <div><p class="text-4xl font-extrabold text-primary">Telehealth</p><p class="text-xs uppercase tracking-widest mt-1 text-gray-400">Available Daily</p></div>
        <div><p class="text-4xl font-extrabold text-primary">Doctoral</p><p class="text-xs uppercase tracking-widest mt-1 text-gray-400">Level Clinicians</p></div>
      </div>
    </section>

    <!-- WHY GLOBECORE -->
    <section class="py-24 bg-bgOffWhite">
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:flex gap-16 items-center">
        <div class="flex-1">
        ...
        <div class="flex-1 mt-12 lg:mt-0 grid grid-cols-2 gap-5 text-sm">
          ...
          <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm"><h4 class="font-bold mb-1">Discreet Care</h4><p class="text-gray-500">A professional, quiet environment designed for your privacy.</p></div>
          <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm"><h4 class="font-bold mb-1">Advanced Tech</h4><p class="text-gray-500">Access to cutting-edge neurotherapy like Deep TMS.</p></div>
          <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm"><h4 class="font-bold mb-1">Telehealth Ready</h4><p class="text-gray-500">Safe, HIPAA-compliant video sessions from anywhere.</p></div>
        </div>
      </div>
    </section>
    ...
    <section class="py-20 bg-white border-t border-gray-100">
      <div class="max-w-4xl mx-auto px-4">
        <h2 class="text-3xl font-bold text-center text-[#071e26] mb-12">Buckhead FAQ</h2>
        <div class="space-y-4">
          <details class="group bg-bgOffWhite p-6 rounded-2xl hover:bg-white border border-transparent hover:border-gray-200"><summary class="flex justify-between items-center font-bold text-lg cursor-pointer"><h3>Is the Buckhead office near MARTA?</h3><span class="faq-chevron text-primary"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg></span></summary><p class="mt-4 text-gray-600 leading-relaxed">Yes, we are a 2-minute walk from the Lenox MARTA station, making it very convenient for commuters.</p></details>
          <details class="group bg-bgOffWhite p-6 rounded-2xl hover:bg-white border border-transparent hover:border-gray-200"><summary class="flex justify-between items-center font-bold text-lg cursor-pointer"><h3>Do you offer evening appointments in Buckhead?</h3><span class="faq-chevron text-primary"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg></span></summary><p class="mt-4 text-gray-600 leading-relaxed">Yes, we offer flexible scheduling including evening hours Monday through Friday to accommodate working professionals.</p></details>
        </div>
      </div>
    </section>
