...
<img alt="Best Psychiatrist in Atlanta: Expert Mental Health Care You Can Trust" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000 ease-out" src="/wp-content/uploads/2025/12/best-psychiatrist-in-atlanta.png"/>
</a>
...
<img alt="Psychiatrist in Atlanta That Accept Medicaid: Your Complete Guide to Accessible Mental Health Care" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000 ease-out" src="/wp-content/uploads/2025/12/unnamed-4.png"/>
</a>
<div class="absolute inset-0 bg-gradient-to-t md:bg-gradient-to-r from-[#071e26]/50 md:from-[#071e26]/30 to-transparent pointer-events-none"></div>
<div class="absolute top-6 left-6 z-10">
<span class="bg-white/95 backdrop-blur-md text-[#071e26] text-[10px] font-extrabold px-3 py-1.5 rounded-full shadow-sm uppercase tracking-[0.15em] block">
...
<h2 class="text-[22px] md:text-[28px] lg:text-[32px] font-extrabold text-[#071e26] leading-snug font-raleway mb-4 group-hover:text-primary transition-colors duration-300">
<a class="focus:outline-none before:absolute before:inset-0 cursor-pointer" href="./psychiatrist-in-atlanta-that-accept-medicaid.php">Psychiatrist in Atlanta That Accept Medicaid: Your Complete Guide to Accessible Mental Health Care</a>
</h2>
<div class="text-gray-500 text-[15px] md:text-[16px] leading-relaxed mb-8 flex-grow">
<p>Finding a psychiatrist in Atlanta that accepts Medicaid can be a frustrating and time-consuming process. Many mental health providers in Georgia operate on a private-pay basis, making it difficult for individuals and families with Medicaid coverage to find the high-quality care they deserve. At GlobeCore, we believe that everyone should have access to compassionate, expert […]</p>
</div>
<div class="mt-auto pt-6 border-t border-gray-100 flex items-center justify-between z-20 relative">
<span class="text-[10px] font-extrabold text-gray-400 uppercase tracking-widest flex items-center gap-2">
                                By Kelly Lewis-Arthur
...
<img alt="Atlanta’s Best Psychiatrist: Where Cultural Understanding Meets Compassionate, Effective Care" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000 ease-out" src="/wp-content/uploads/2025/12/globe-core-50.jpg"/>
</a>
<div class="absolute inset-0 bg-gradient-to-t md:bg-gradient-to-r from-[#071e26]/50 md:from-[#071e26]/30 to-transparent pointer-events-none"></div>
<div class="absolute top-6 left-6 z-10">
<span class="bg-white/95 backdrop-blur-md text-[#071e26] text-[10px] font-extrabold px-3 py-1.5 rounded-full shadow-sm uppercase tracking-[0.15em] block">
...
<h2 class="text-[22px] md:text-[28px] lg:text-[32px] font-extrabold text-[#071e26] leading-snug font-raleway mb-4 group-hover:text-primary transition-colors duration-300">
<a class="focus:outline-none before:absolute before:inset-0 cursor-pointer" href="./psychiatrist-in-atlanta-ga.php">Atlanta’s Best Psychiatrist: Where Cultural Understanding Meets Compassionate, Effective Care</a>
</h2>
<div class="text-gray-500 text-[15px] md:text-[16px] leading-relaxed mb-8 flex-grow">
<p>If you’re searching for a psychiatrist in Atlanta GA, you’re likely seeking expert care that goes beyond medication—a trusted professional who listens, understands, and guides you toward better mental well-being. The right psychiatrist in Atlanta GA can help you find clarity, restore balance, and build a healthier life through evidence-based and compassionate treatment. At […]</p>
</div>
<div class="mt-auto pt-6 border-t border-gray-100 flex items-center justify-between z-20 relative">
<span class="text-[10px] font-extrabold text-gray-400 uppercase tracking-widest flex items-center gap-2">
                                By Kelly Lewis-Arthur
...
<img alt="Clinical Psychology vs Counseling Psychology: Key Differences" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000 ease-out" src="/wp-content/uploads/2025/12/47477.jpg"/>
</a>
<div class="absolute inset-0 bg-gradient-to-t md:bg-gradient-to-r from-[#071e26]/50 md:from-[#071e26]/30 to-transparent pointer-events-none"></div>
<div class="absolute top-6 left-6 z-10">
<span class="bg-white/95 backdrop-blur-md text-[#071e26] text-[10px] font-extrabold px-3 py-1.5 rounded-full shadow-sm uppercase tracking-[0.15em] block">
...
<img alt="How to Prepare for Your First Therapy Session: A Step-by-Step Guide" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000 ease-out" src="/wp-content/uploads/2025/12/2150225244.jpg"/>
</a>
<div class="absolute inset-0 bg-gradient-to-t md:bg-gradient-to-r from-[#071e26]/50 md:from-[#071e26]/30 to-transparent pointer-events-none"></div>
<div class="absolute top-6 left-6 z-10">
<span class="bg-white/95 backdrop-blur-md text-[#071e26] text-[10px] font-extrabold px-3 py-1.5 rounded-full shadow-sm uppercase tracking-[0.15em] block">
...
<h2 class="text-[22px] md:text-[28px] lg:text-[32px] font-extrabold text-[#071e26] leading-snug font-raleway mb-4 group-hover:text-primary transition-colors duration-300">
<a class="focus:outline-none before:absolute before:inset-0 cursor-pointer" href="./how-to-prepare-for-your-first-therapy-session.php">How to Prepare for Your First Therapy Session: A Step-by-Step Guide</a>
</h2>
<div class="text-gray-500 text-[15px] md:text-[16px] leading-relaxed mb-8 flex-grow">
<p>Beginning therapy can be one of the most meaningful decisions you’ll ever make for your well-being. Yet, it’s also normal to feel uncertain, nervous, or even skeptical before your first session. Whether you’re seeing a psychologist, psychiatrist, or therapist for the first time, preparation can make a real difference. Knowing what to expect and how […]</p>
</div>
<div class="mt-auto pt-6 border-t border-gray-100 flex items-center justify-between z-20 relative">
<span class="text-[10px] font-extrabold text-gray-400 uppercase tracking-widest flex items-center gap-2">
                                By Kelly Lewis-Arthur
...
<!-- Pagination block -->
            <div class="mt-16 flex justify-center items-center gap-2 md:gap-3 font-inter flex-wrap">
                <a href="./page-2.php" class="px-6 h-12 mr-2 flex items-center justify-center rounded-full bg-white border border-gray-100 text-[#071e26] font-extrabold text-lg shadow-sm hover:border-[#071e26] transition-all group gap-2">
            ...
            Prev
                ...
                <span class="w-12 h-12 flex items-center justify-center rounded-full bg-[#071e26] text-white font-extrabold text-lg shadow-[0_8px_16px_rgb(7,30,38,0.2)]">3</span>
                ...
                <a href="./page-4.php" class="px-6 h-12 ml-2 flex items-center justify-center rounded-full bg-white border border-gray-100 text-[#071e26] font-extrabold text-lg shadow-sm hover:border-[#071e26] transition-all group gap-2">
            Next
            <svg class="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
