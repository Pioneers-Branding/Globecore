...
<head>
<?php
$pageTitle = "Does TRICARE Cover TMS Therapy? Coverage, Costs & Requirements | GlobeCoRe Inc.";
...
<body class="font-raleway text-textMain bg-white">
    ...
    <div class="bg-gray-50 border-b border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center gap-2 text-sm font-medium text-gray-500">
            ...
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
            <span class="text-gray-900 line-clamp-1">Does TRICARE Cover TMS Therapy? Coverage, Costs & Requirements</span>
        </div>
    </div>
    ...
    <section class="bg-[#071e26] py-20 relative overflow-hidden">
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 relative z-10 text-center">
            <div class="flex items-center justify-center gap-4 text-gray-400 text-xs font-bold uppercase tracking-widest mb-8">
                <span class="flex items-center gap-2"><svg class="w-4 h-4 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg> April 14, 2026</span>
            ...
            <h1 class="text-3xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-10 font-raleway">
                Does TRICARE Cover TMS Therapy? Coverage, Costs & Requirements
            </h1>
            <p class="text-gray-300 text-lg md:text-xl max-w-3xl mx-auto mb-10 leading-relaxed italic">
                Does TRICARE cover TMS therapy? Learn about TRICARE TMS coverage, eligibility requirements, costs, and how to access TMS for depression and OCD in Palm Springs.
            </p>
            ...
            <div class="flex flex-col lg:flex-row gap-16">
                ...
                <div class="lg:w-3/4">
                    <div class="rounded-[2.5rem] overflow-hidden mb-16 shadow-2xl relative group">
                        <img src="/assets/blog/can_veterens_get_tricare_for_tms_therapy.jpg" alt="Does TRICARE Cover TMS Therapy? Coverage, Costs & Requirements" class="w-full h-auto object-cover max-h-[600px] group-hover:scale-105 transition-transform duration-700">
                    </div>

                    <div id="introduction" class="article-content text-[17px] md:text-[18px]">
                        <p class="text-xl font-medium mb-6">Does TRICARE cover TMS therapy? Learn about TRICARE TMS coverage, eligibility requirements, costs, and how to access TMS for depression and OCD in Palm Springs.</p>
                <p>Full content for this article is being migrated. Please contact GlobeCore for more details on Does TRICARE Cover TMS Therapy? Coverage, Costs & Requirements.</p>
