...
<head>
<?php
$pageTitle = "Does Medicaid Cover TMS Therapy? A Complete Guide 2026 | GlobeCoRe Inc.";
...
<body class="font-raleway text-textMain bg-white">
    ...
    <div class="bg-gray-50 border-b border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center gap-2 text-sm font-medium text-gray-500">
            ...
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
            <span class="text-gray-900 line-clamp-1">Does Medicaid Cover TMS Therapy? A Complete Guide 2026</span>
        </div>
    </div>
    ...
    <section class="bg-[#071e26] py-20 relative overflow-hidden">
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 relative z-10 text-center">
            <div class="flex items-center justify-center gap-4 text-gray-400 text-xs font-bold uppercase tracking-widest mb-8">
                <span class="flex items-center gap-2"><svg class="w-4 h-4 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg> February 17, 2026</span>
            ...
            <div class="flex flex-col lg:flex-row gap-16">
                ...
                <div class="lg:w-3/4">
                    <div class="rounded-[2.5rem] overflow-hidden mb-16 shadow-2xl relative group">
                        <img src="/assets/blog/Psychiatrist_in_Atlanta_That_Accept_Medicaid.png" alt="Does Medicaid Cover TMS Therapy? A Complete Guide 2026" class="w-full h-auto object-cover max-h-[600px] group-hover:scale-105 transition-transform duration-700">
                    </div>

                    <div id="introduction" class="article-content text-[17px] md:text-[18px]">
                        <p class="text-xl font-medium mb-6">Navigating mental health coverage can be confusing. Here’s everything you need to know about accessing TMS therapy through Medicaid.</p>
                <p>Full content for this article is being migrated. Please contact GlobeCore for more details on Does Medicaid Cover TMS Therapy? A Complete Guide 2026.</p>
